...
# save
torch.save(unlabeled_loader, 'data-local/processed/unlabeled_loader_{}.pth'.format(NUM_LABELED))
torch.save(train_loader, 'data-local/processed/train_loader_{}.pth'.format(NUM_LABELED))
torch.save(val_loader, 'data-local/processed/val_loader_{}.pth'.format(NUM_LABELED))
torch.save(all_loader, 'data-local/processed/all_loader_{}.pth'.format(NUM_LABELED))
with open('data-local/processed/token2id_{}.pickle'.format(NUM_LABELED), 'wb') as handle:
